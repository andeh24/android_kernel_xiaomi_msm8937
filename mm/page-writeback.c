 ...
 */
#define MAX_PAUSE		msecs_to_jiffies(200)
 ...
 */
#define BANDWIDTH_INTERVAL	msecs_to_jiffies(200)
				   ...
				   unsigned long bdi_dirty)
{
	 ...
	 */
	t = bdi_dirty / (1 + bw / roundup_pow_of_two(1 + msecs_to_jiffies(125)));
	t++;
