...
#if defined (CONFIG_UGGLITE) || defined (CONFIG_UGG)
static const char * const msm8x16_external_hp_analog_switch_text[] = {
				"OFF", "ON"};
static const struct soc_enum msm8x16_external_hp_analog_switch_enum[] = {
				SOC_ENUM_SINGLE_EXT(2, msm8x16_external_hp_analog_switch_text),
};
#endif
...
#if defined (CONFIG_UGGLITE) || defined (CONFIG_UGG)
	SOC_ENUM_EXT("HP ANALOG SWITCH", msm8x16_external_hp_analog_switch_enum[0],
...
#if defined(CONFIG_SPEAKER_EXT_PA)
		 pdata->pa_is_on = 0;
		pr_debug("At %d In (%s), will run msm8x16_spk_ext_pa_ctrl,true\n",__LINE__, __FUNCTION__);
